...
const navigation = [
  ...
  { name: "Wizard IA", href: "/wizard", icon: "zap" },
  { name: "Inbox", href: "/inbox", icon: "mail" },
  { name: "Agenda", href: "/calendar", icon: "calendar" },
  { name: "Pipeline", href: "/pipeline", icon: "bar-chart" },
  { name: "Contactos", href: "/contacts", icon: "users" },
  { name: "Campañas", href: "/campaigns", icon: "send" },
  { name: "Automatizaciones", href: "/automations", icon: "cpu" },
  { name: "Productos", href: "/products", icon: "package" },
  { name: "Ingresos", href: "/revenue", icon: "dollar" },
  { name: "Templates", href: "/templates", icon: "file-text" },
  { name: "Importar", href: "/import", icon: "upload" },
  { name: "Contenido", href: "/content", icon: "edit" },
  { name: "Competencia", href: "/spy", icon: "eye" },
  { name: "Referidos", href: "/referrals", icon: "gift" },
  { name: "Warm-up", href: "/warmup", icon: "shield" },
...
function NavIcon({ name }: { name: string }) {
  const icons: Record<string, React.ReactNode> = {
    ...
    send: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg>,
    cpu: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
    ...
    "file-text": <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>,
    upload: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>,
    ...
    gift: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" /></svg>,
    ...
    <div className="flex h-screen w-60 flex-col bg-white border-r border-gray-200">
      ...
      <div className="flex h-14 items-center px-5 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900 text-sm">ProspectorAI</span>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t border-gray-100 flex items-center gap-2.5">
        ...
        <div>
          <p className="text-xs font-medium text-gray-900">Mi Cuenta</p>
